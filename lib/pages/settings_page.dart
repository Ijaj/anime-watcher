  ...
  Future<void> _clearHistory() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Every episode becomes unwatched and all resume positions are forgotten. '
      ...
      body: Center(
        child: ConstrainedBox(
          ...
          child: ListView(padding: const EdgeInsets.all(24), children: [
            section('MyAnimeList'),
            const Text('Metadata lookups use a MyAnimeList API client ID. Leave this empty to use the built-in one, '
